...
Config::Config () {
  ...
  mappings.emplace("show", VK_F11);
  mappings.emplace("collision", VK_F5);
  mappings.emplace("stealth", VK_F10);
  mappings.emplace("ai", VK_F8);
  mappings.emplace("no_damage", VK_F9);
  mappings.emplace("consume", VK_F4);
  mappings.emplace("quitout", VK_F6);
